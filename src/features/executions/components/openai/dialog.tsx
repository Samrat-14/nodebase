...
export function OpenAiDialog({
  ...
  const watchVariableName = form.watch('variableName') || 'openai_node';
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid}>
                ...
                <Input placeholder="openai_node" {...field} aria-invalid={fieldState.invalid} />
                <FieldDescription>
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid}>
                ...
                <FieldDescription>The OpenAI model to use for completion</FieldDescription>
                {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
              </Field>
            )}
          />
